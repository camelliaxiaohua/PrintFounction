...
public class GetPathTest {
    ...
    void  getPathByClassPathResource(){
        ...
        URL url = getClass().getClassLoader().getResource("templates/thymeleaf.html");
        // 获取资源的路径
    ...
    void getPathByClass(){
        ...
        URL url = getClass().getResource("/templates/thymeleaf.html");
        // 提取资源路径
        String path = url.getPath();
        // 输出路径信息
    ...
    void getPathByFile(){
        ...
        File file = new File("src/main/resources/templates/thymeleaf.html");
        // 获取文件的绝对路径
    ...
    @Test
    void getPathByPaths(){
        // 创建一个Path对象，指向资源文件"src/main/resources/templates/thymeleaf.html"
        Path path = Paths.get("src/main/resources/templates/thymeleaf.html");
        // 将Path对象转换为绝对路径字符串
    ...
    void getPathBySystem(){
        ...
        // 拼接项目中的资源文件路径
        String path = userDir + "\\src\\main\\resources\\templates\\thymeleaf.html";
        // 打印通过系统属性获取的资源路径
